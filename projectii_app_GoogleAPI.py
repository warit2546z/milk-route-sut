...
with st.sidebar:
    ...
    # ✨ อัปเดตค่าเริ่มต้นน้ำหนักบรรทุกตามที่ระบุ
    ...
    with col3:
        ...
        cap_4w = st.number_input("บรรทุก 4 ล้อ", min_value=1000, value=9500, step=500, key="cap_4")
    with col4:
        cap_box = st.number_input("กระบะตู้ทึบ", min_value=500, value=2500, step=100, key="cap_b")
        cap_6w = st.number_input("บรรทุก 6 ล้อ", min_value=2000, value=15000, step=500, key="cap_6")
