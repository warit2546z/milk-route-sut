...
# 🔒 ไม้ตายสุดท้าย: สั่งปิดการแจ้งเตือนความปลอดภัยเพื่อจงใจเจาะทะลุ SSL Gateway
...
if st.button("🚀 ประมวลผลเส้นทางและวิเคราะห์เปรียบเทียบ", type="primary", use_container_width=True):
    ...
    if solution:
        ...
        for idx, route in enumerate(all_routes):
            ...
            if res.status_code == 200:
                ...
                if gmaps_data.get('status') == 'OK':
                    ...
                    # 🛣️ ดึงพิกัดแบบความละเอียดสูง (Step-by-step) ประกบผิวถนน
                    polyline_coords = []
                    for leg in legs:
        ...
        with col_map:
            ...
            # 🌍 เรียกแผนที่ฐานเลเยอร์ของ Google Maps เพื่อความเที่ยงตรงของพิกัดถนน
            folium.TileLayer(
        ...
        # --- ตารางคิวงานแยกตามประเภทรถคันขับ ---
        with col_table:
