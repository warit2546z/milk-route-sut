            ...
            for rr in route_results:
                ...
                for i, n in enumerate(rr['indices'][:-1]):
                    ...
                    schedule.append({
                        ...
                        "สภาพจราจรรายจุด": traffic_status,                                          # เปลี่ยนคอลัมน์ใหม่
                        "เวลาที่เสียจากรถติด (นาที)": f"{delay_min:.1f} นาที" if i > 0 else "-",      # เปลี่ยนคอลัมน์ใหม่
                        "คาร์บอน CO2 (kg)": f"{co2_leg:.2f}" if i > 0 else "-",
