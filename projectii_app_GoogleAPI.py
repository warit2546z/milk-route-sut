...
import pandas as pd
import io
import json # ✨ [เพิ่มใหม่] นำเข้าไลบรารี json สำหรับทำ GeoJSON
...
# ✨ [เพิ่มใหม่] ฟังก์ชันสร้างไฟล์ GeoJSON สำหรับใช้งานกับ QGIS หรือระบบ GIS ทั่วไป
...
st.markdown("ระบบวิเคราะห์เส้นทางอัจฉริยะ (Routes API v2 + Optimization Sandbox)")
    ...
    if solution:
        ...
        if route_results:
            ...
            with col_table:
                ...
                # ✨ [ปรับแก้] แบ่งปุ่มดาวน์โหลดเป็น 4 คอลัมน์ และเพิ่มปุ่มดาวน์โหลด .GeoJSON 
                st.write("---")
