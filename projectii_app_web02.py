...
Original file is located at
    https://colab.research.google.com/drive/18lG85nJNPAbdQM6wSlj7_VYU0lZQQfhL
"""

!pip install streamlit ortools folium streamlit-folium requests pandas
...
#         search_parameters.time_limit.seconds = 5 # ลดเวลาประมวลผลลงเพื่อความรวดเร็ว
# 
...
# 
#                     # แก้ไขบั๊กของ Colab ด้วยการใช้ st.table แทน st.dataframe
...
#                     folium.TileLayer(tiles=f"https://api.tomtom.com/traffic/map/4/tile/flow/relative0-dark/{{z}}/{{x}}/{{y}}.png?key={API_KEY}", attr='TomTom', name='Traffic', overlay=True).add_to(m)
# 
#                     all_points = []
#                     for leg in legs:
#                         for p in leg['points']:
