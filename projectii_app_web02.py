...
st.markdown("วิเคราะห์ประสิทธิภาพโลจิสติกส์ พร้อมระบบ Deep Link สั่งเปิดแผนที่นำทางสำหรับคนขับ")
        ...
        if res.status_code == 200:
            ...
            with col_table:
                ...
                for i, n in enumerate(route_indices[:-1]):
                    ...
                    # ✨ สร้าง Deep Link สำหรับ Google Maps
                    ...
                    schedule.append({
                        ...
                        "นำทาง": maps_url if i > 0 else None, # จุดเริ่มต้นไม่ต้องมีลิงก์นำทาง
                ...
                # ✨ ตั้งค่าให้ Streamlit แปลง URL เป็นลิงก์ที่กดได้สวยๆ
                st.dataframe(
                    df_schedule, 
