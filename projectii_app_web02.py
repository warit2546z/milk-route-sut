...
st.markdown("วิเคราะห์ประสิทธิภาพโลจิสติกส์: จราจร Real-time, ระยะทาง, ต้นทุน และสิ่งแวดล้อม")
    ...
    if solution:
        ...
        if res.status_code == 200:
            ...
            with col_map:
                ...
                # ✨ ฟีเจอร์ที่ขอมา: เพิ่มเลเยอร์ปริมาณการจราจร (Traffic Flow Tiles)
                folium.TileLayer(
                ...
                # วาดเส้นทางที่คำนวณได้
                all_points = []
                for leg in route_data['legs']:
                    for p in leg['points']: all_points.append([p['latitude'], p['longitude']])
                folium.PolyLine(all_points, color="#2980B9", weight=6, opacity=0.8, name='เส้นทางที่แนะนำ').add_to(m)
                ...
                folium.LayerControl().add_to(m) # ปุ่มเปิด-ปิดเลเยอร์จราจร
